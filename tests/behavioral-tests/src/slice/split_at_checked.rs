#![cfg(feature = "test_slice_split_at_checked")]
...
test_runner! {
    ...
    shader: {
        ...
        let result = if let Some((left, right)) = values.split_at_checked(mid) {
            TestResult {
...
async fn run() -> Result<(), Box<dyn Error>> {
    ...
    // Case 1: split_at_checked(0) -> [10, 20, 30, 40] -> ([], [10, 20, 30, 40])
    assert_eq!(
    ...
    // Case 2: split_at_checked(2) -> [10, 20, 30, 40] -> ([10, 20], [30, 40])
    assert_eq!(
    ...
    // Case 3: split_at_checked(4) -> [10, 20, 30, 40] -> ([10, 20, 30, 40], [])
    assert_eq!(
    ...
    // Case 4: split_at_checked(5) -> [10, 20, 30, 40] -> None
    assert_eq!(
