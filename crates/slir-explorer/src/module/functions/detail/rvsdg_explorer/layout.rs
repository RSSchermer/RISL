    ...
    pub fn init(config: &Config, rvsdg: &Rvsdg, node: Node) -> Self {
        ...
        let content = match data.kind() {
            ...
            NodeKind::Simple(simple_node) => match simple_node {
                ...
                SimpleNode::OpSaturate(_) => NodeContent::PlainText("saturate".into()),
                ...
                SimpleNode::OpFusedMulAdd(_) => NodeContent::PlainText("fma".into()),
                ...
                SimpleNode::OpAcosh(_) => NodeContent::PlainText("acosh".into()),
                SimpleNode::OpSin(_) => NodeContent::PlainText("sin".into()),
                SimpleNode::OpAsin(_) => NodeContent::PlainText("asin".into()),
                SimpleNode::OpSinh(_) => NodeContent::PlainText("sinh".into()),
                SimpleNode::OpAsinh(_) => NodeContent::PlainText("asinh".into()),
                SimpleNode::OpTan(_) => NodeContent::PlainText("tan".into()),
