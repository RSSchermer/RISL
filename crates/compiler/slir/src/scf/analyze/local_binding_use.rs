...
impl UseCounter {
    ...
    fn count_expr_binding(&mut self, _scf: &Scf, stmt: &ExprBinding) {
        match stmt.expression().kind() {
            ...
            ExpressionKind::OpRoundToEven(op) => self.count_intrinsic_op_binding(op),
            ExpressionKind::OpSaturate(op) => self.count_intrinsic_op_binding(op),
            ...
            ExpressionKind::OpExp(op) => self.count_intrinsic_op_binding(op),
            ...
            ExpressionKind::OpStep(op) => self.count_intrinsic_op_binding(op),
            ExpressionKind::OpSmoothStep(op) => self.count_intrinsic_op_binding(op),
            ...
            ExpressionKind::OpAcosh(op) => self.count_intrinsic_op_binding(op),
            ExpressionKind::OpSin(op) => self.count_intrinsic_op_binding(op),
            ExpressionKind::OpAsin(op) => self.count_intrinsic_op_binding(op),
            ExpressionKind::OpSinh(op) => self.count_intrinsic_op_binding(op),
            ExpressionKind::OpAsinh(op) => self.count_intrinsic_op_binding(op),
            ExpressionKind::OpTan(op) => self.count_intrinsic_op_binding(op),
