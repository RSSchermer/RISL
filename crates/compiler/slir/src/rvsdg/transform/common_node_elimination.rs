...
impl SimpleNodeMetadata {
    fn from_simple_node(node: &SimpleNode) -> Option<Self> {
        let metadata = match node {
            ...
            SimpleNode::OpRoundToEven(_) => SimpleNodeMetadata::OpRoundToEven,
            SimpleNode::OpSaturate(_) => SimpleNodeMetadata::OpSaturate,
            SimpleNode::OpFloor(_) => SimpleNodeMetadata::OpFloor,
            SimpleNode::OpCeil(_) => SimpleNodeMetadata::OpCeil,
            SimpleNode::OpClamp(_) => SimpleNodeMetadata::OpClamp,
            SimpleNode::OpFract(_) => SimpleNodeMetadata::OpFract,
            SimpleNode::OpFusedMulAdd(_) => SimpleNodeMetadata::OpFusedMulAdd,
            SimpleNode::OpTrunc(_) => SimpleNodeMetadata::OpTrunc,
            SimpleNode::OpSqrt(_) => SimpleNodeMetadata::OpSqrt,
            SimpleNode::OpInverseSqrt(_) => SimpleNodeMetadata::OpInverseSqrt,
            SimpleNode::OpExp(_) => SimpleNodeMetadata::OpExp,
            SimpleNode::OpExp2(_) => SimpleNodeMetadata::OpExp2,
            SimpleNode::OpLog(_) => SimpleNodeMetadata::OpLog,
            SimpleNode::OpLog2(_) => SimpleNodeMetadata::OpLog2,
            SimpleNode::OpPowf(_) => SimpleNodeMetadata::OpPowf,
            SimpleNode::OpStep(_) => SimpleNodeMetadata::OpStep,
            SimpleNode::OpSmoothStep(_) => SimpleNodeMetadata::OpSmoothStep,
            SimpleNode::OpCos(_) => SimpleNodeMetadata::OpCos,
            SimpleNode::OpAcos(_) => SimpleNodeMetadata::OpAcos,
            SimpleNode::OpCosh(_) => SimpleNodeMetadata::OpCosh,
            SimpleNode::OpAcosh(_) => SimpleNodeMetadata::OpAcosh,
            SimpleNode::OpSin(_) => SimpleNodeMetadata::OpSin,
            SimpleNode::OpAsin(_) => SimpleNodeMetadata::OpAsin,
            SimpleNode::OpSinh(_) => SimpleNodeMetadata::OpSinh,
            SimpleNode::OpAsinh(_) => SimpleNodeMetadata::OpAsinh,
            SimpleNode::OpTan(_) => SimpleNodeMetadata::OpTan,
