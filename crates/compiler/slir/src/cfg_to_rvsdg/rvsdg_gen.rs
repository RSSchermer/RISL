...
impl<'a> RegionBuilder<'a> {
    ...
    fn visit_statement(&mut self, statement: &StatementData) {
        match statement {
            ...
            StatementData::OpFusedMulAdd(op) => self.visit_intrinsic_op(op),
            ...
            StatementData::OpExp(op) => self.visit_intrinsic_op(op),
            StatementData::OpExp2(op) => self.visit_intrinsic_op(op),
            ...
            StatementData::OpAcosh(op) => self.visit_intrinsic_op(op),
            StatementData::OpSin(op) => self.visit_intrinsic_op(op),
            StatementData::OpAsin(op) => self.visit_intrinsic_op(op),
            StatementData::OpSinh(op) => self.visit_intrinsic_op(op),
            StatementData::OpAsinh(op) => self.visit_intrinsic_op(op),
            StatementData::OpTan(op) => self.visit_intrinsic_op(op),
