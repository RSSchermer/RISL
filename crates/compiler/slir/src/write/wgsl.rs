...
impl WgslModuleWriter {
    ...
    fn write_expression(&mut self, cx: Context, expression: &Expression, inline_cx: InlineContext) {
        match expression.kind() {
            ...
            ExpressionKind::OpSaturate(op) => self.write_fn_like_intrinsic(cx, op, "saturate"),
            ...
            ExpressionKind::OpFract(op) => self.write_fn_like_intrinsic(cx, op, "fract"),
            ExpressionKind::OpFusedMulAdd(op) => self.write_fn_like_intrinsic(cx, op, "fma"),
            ExpressionKind::OpTrunc(op) => self.write_fn_like_intrinsic(cx, op, "trunc"),
            ...
            ExpressionKind::OpAcosh(op) => self.write_fn_like_intrinsic(cx, op, "acosh"),
            ExpressionKind::OpSin(op) => self.write_fn_like_intrinsic(cx, op, "sin"),
            ExpressionKind::OpAsin(op) => self.write_fn_like_intrinsic(cx, op, "asin"),
            ExpressionKind::OpSinh(op) => self.write_fn_like_intrinsic(cx, op, "sinh"),
            ExpressionKind::OpAsinh(op) => self.write_fn_like_intrinsic(cx, op, "asinh"),
            ExpressionKind::OpTan(op) => self.write_fn_like_intrinsic(cx, op, "tan"),
