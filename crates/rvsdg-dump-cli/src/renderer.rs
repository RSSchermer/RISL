...
impl<'a> Renderer<'a> {
    ...
    fn write_simple_node<W: std::io::Write>(
        ...
        match simple {
            ...
            SimpleNode::OpFusedMulAdd(_) => self.write_node_common(writer, node, "OpFusedMulAdd"),
            ...
            SimpleNode::OpAcosh(_) => self.write_node_common(writer, node, "OpAcosh"),
            SimpleNode::OpSin(_) => self.write_node_common(writer, node, "OpSin"),
            SimpleNode::OpAsin(_) => self.write_node_common(writer, node, "OpAsin"),
            SimpleNode::OpSinh(_) => self.write_node_common(writer, node, "OpSinh"),
            SimpleNode::OpAsinh(_) => self.write_node_common(writer, node, "OpAsinh"),
            SimpleNode::OpTan(_) => self.write_node_common(writer, node, "OpTan"),
